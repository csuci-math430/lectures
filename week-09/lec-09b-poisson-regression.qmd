...
## Logistic model conditions

1. Binary response variable.
2. Linear relationship between predictors and log odds.
3. Independence of observations.
4. Little to no multicolinearity (correlation) among predictors.
5. No high-leverage outliers (extreme observations that pull the line).

## Poisson model conditions

1. Discrete numeric response variable.
2. Linear relationship between predictors and log expected count.
3. Independence of observations.
4. $E[Y_i | X_i] = Var(Y_i | X_i)$.
5. Little to no multicolinearity (correlation) among predictors.
6. No high-leverage outliers (extreme observations that pull the line).
