...
**Statistics conclusion**: Our p-value is `r partial_f_test_p_value`. Therefore there is very strong evidence against $H_0$ in support of $H_A$.

. . .

**Conclusion in context**: We found very strong evidence (p-value = `r partial_f_test_p_value`) that at least one of student-teacher ratio or student-computer ratio is linearly related to score, in addition to lunch.
